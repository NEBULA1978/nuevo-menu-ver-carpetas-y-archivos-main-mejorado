...
# Este script primero verifica si el archivo log.log ya existe, y si es así, no ejecuta el comando curl de nuevo. Luego, utiliza la expresión regular para extraer los nombres de las máquinas y los guarda en el archivo log.log2.
